...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        printData(tasksData);
        printDataUsingStringStreams(tasksData);
    ...
    public static void printDataUsingStringStreams(ArrayList<Task> tasks) {
    ...
    public static void printDeadlinesUsingStream(ArrayList<Task> tasks) {
        tasks.stream()
                .filter(t -> t instanceof Deadline)
                .forEach((System.out::println));//filter takes a predicate
    }
}
